  ...
  for (i = 0; i < sizeof (tv) / sizeof (tv[0]); i++)
	...
	case NUM:
	  for (j = 0; j < strlen (challenge); j++)
		...
		{
		  printf
		    ("NUM challenge contains non-digit char at position %d: %c\n",
		     j, *tmp);
		  return 1;
		}
	    }
	...
	case HEX:
	  for (j = 0; j < strlen (challenge); j++)
		...
		{
		  printf
		    ("HEX challenge contains non-hex char at position %d: %c\n",
		     j, *tmp);
		  return 1;
		}
	    }
	...
	case ALPHA:
	  for (j = 0; j < strlen (challenge); j++)
		...
		{
		  printf
		    ("ALPHA challenge contains non-alphanumeric char at position %d: %c\n",
		     j, *tmp);
		  return 1;
		}
	    }
