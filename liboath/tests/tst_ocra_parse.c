...
{
  {
    ...
    {
  0, NO_HASH, SHA1, NUM, 8, 0, 0, 8, 152}, OATH_OK},
  {
  ...
  }, -1},
  {
    ...
    {
  1, NO_HASH, SHA256, ALPHA, 10, 0, 0, 6, 164}, OATH_OK},
  {
    "OCRA-1:HOTP-SHA512-2:C-QH24",
    {
  1, NO_HASH, SHA512, HEX, 24, 0, 0, 2, 0}, -1},
  {
    "OCRA-1:HOTP-SHA1-0:C-QA20-PSHA512-S128-T12M",
    {
  1, SHA512, SHA1, ALPHA, 20, 720, 128, 0, 380}, OATH_OK}
};
